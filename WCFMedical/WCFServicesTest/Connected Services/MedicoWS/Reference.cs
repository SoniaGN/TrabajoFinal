...
namespace WCFServicesTest.MedicoWS {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MedicoWS.IMedicos")]
    public interface IMedicos {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WCFServicesTest.MedicoWS.RepetidoException), Action="http://tempuri.org/IMedicos/CrearMedicoRepetidoExceptionFault", Name="RepetidoException", Namespace="http://schemas.datacontract.org/2004/07/WCFServices.Errores")]
        WCFServicesTest.MedicoWS.Medico CrearMedico(WCFServicesTest.MedicoWS.Medico medicoACrear);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMedicos/CrearMedico", ReplyAction="http://tempuri.org/IMedicos/CrearMedicoResponse")]
        System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico> CrearMedicoAsync(WCFServicesTest.MedicoWS.Medico medicoACrear);
        ...
        WCFServicesTest.MedicoWS.Medico ObtenerMedico(int dni);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMedicos/ObtenerMedico", ReplyAction="http://tempuri.org/IMedicos/ObtenerMedicoResponse")]
        System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico> ObtenerMedicoAsync(int dni);
        ...
        WCFServicesTest.MedicoWS.Medico[] ListarMedicos();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMedicos/ListarMedicos", ReplyAction="http://tempuri.org/IMedicos/ListarMedicosResponse")]
        System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico[]> ListarMedicosAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMedicosChannel : WCFServicesTest.MedicoWS.IMedicos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MedicosClient : System.ServiceModel.ClientBase<WCFServicesTest.MedicoWS.IMedicos>, WCFServicesTest.MedicoWS.IMedicos {
        ...
        public WCFServicesTest.MedicoWS.Medico CrearMedico(WCFServicesTest.MedicoWS.Medico medicoACrear) {
            return base.Channel.CrearMedico(medicoACrear);
        }
        
        public System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico> CrearMedicoAsync(WCFServicesTest.MedicoWS.Medico medicoACrear) {
            return base.Channel.CrearMedicoAsync(medicoACrear);
        }
        
        public WCFServicesTest.MedicoWS.Medico ObtenerMedico(int dni) {
            return base.Channel.ObtenerMedico(dni);
        }
        
        public System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico> ObtenerMedicoAsync(int dni) {
            return base.Channel.ObtenerMedicoAsync(dni);
        }
        
        public WCFServicesTest.MedicoWS.Medico[] ListarMedicos() {
            return base.Channel.ListarMedicos();
        }
        
        public System.Threading.Tasks.Task<WCFServicesTest.MedicoWS.Medico[]> ListarMedicosAsync() {
